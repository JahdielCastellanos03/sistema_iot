...
urlpatterns = [
    ...
    url(r'^dispositivos/([0-9]+)/eliminar$', views.eliminarDispositivo, name = 'eliminar-dispositivo'),
...
#    modificaiones poot
    url(r'^api/escala-de-valores/$', views.api_escala_de_valores, name='api_escala_de_valores'),
    url(r'^api/escala-de-valores/([0-9]+)/$', views.api_escala_individual, name='api_escala_individual'),
    url(r'^api/rangos/$', views.api_rangos, name='api_rangos'),
    url(r'^api/rangos/([0-9]+)/$', views.api_rango_individual, name='api_rango_individual'),
]
